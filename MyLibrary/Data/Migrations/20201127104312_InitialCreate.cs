...
namespace MyLibrary.Migrations
{
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BookObjectId = table.Column<int>(nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    BookInfoBookId = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BookObjects_Books_BookInfoBookId",
                        column: x => x.BookInfoBookId,
                        principalTable: "Books",
                        principalColumn: "BookId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookObjects_BookInfoBookId",
                table: "BookObjects",
                column: "BookInfoBookId");
